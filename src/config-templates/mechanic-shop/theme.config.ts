...
export const mechanicTheme: ThemeConfig = {
  // COLORS
  // Professional blue and gray palette with orange accents for trust and energy
  colors: {
    primary: {
  ...
  // BORDER RADIUS
  // Moderate border radius for professional but modern look
  borderRadius: {
    none: '0',
    sm: '0.125rem',   // 2px
    base: '0.375rem',  // 6px
  ...
  // SHADOWS
  // Standard shadow system for depth
  shadows: {
    none: 'none',
