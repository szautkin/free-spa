/**
 * MECHANIC SHOP ENGLISH CONTENT CONFIGURATION
 * All text content in English for the mechanic shop template
 */
...
// ========================================
// MECHANIC SHOP ENGLISH CONTENT
// ========================================

export const mechanicShopContentEN: ContentConfig = {
  // SITE METADATA
  metadata: {
  ...
  // SERVICES SECTION (Using menu structure for services)
  menu: {
...
export default mechanicShopContentEN;
