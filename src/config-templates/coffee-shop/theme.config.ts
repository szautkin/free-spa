...
export const coffeeTheme: ThemeConfig = {
  // COLORS
  // Customize: Use warm browns and cream tones for coffee shop feel
  colors: {
    primary: {
  ...
  // TYPOGRAPHY
  // Customize: Choose fonts that match your brand personality
  typography: {
    fontFamily: {
  ...
  // BORDER RADIUS
  // Customize: Increase for softer look, decrease for sharper modern look
  borderRadius: {
    none: '0',
    sm: '0.125rem',   // 2px
    base: '0.25rem',  // 4px
